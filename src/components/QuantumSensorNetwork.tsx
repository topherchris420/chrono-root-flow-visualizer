...
const fragmentShader = `
  ...
  void main() {
    ...
    gl_FragColor = vec4(color, sin(time * 5.0) * 0.5 + 0.5);
  }
`;

interface QuantumSensorNetworkProps {
  count: number;
  color: string;
}

export const QuantumSensorNetwork = ({ count, color }: QuantumSensorNetworkProps) => {
