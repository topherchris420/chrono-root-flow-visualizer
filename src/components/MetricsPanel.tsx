...
export const MetricsPanel = ({ 
  ...
  return (
    <>
      {/* Temporal Metrics - Redesigned */}
      <div className="backdrop-blur-md bg-gradient-to-br from-card/40 to-card/20 border border-primary/20 rounded-2xl p-6 shadow-xl relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-transparent"></div>
        <div className="relative z-10">
          <h3 className="text-sm font-scientific text-primary mb-4 flex items-center gap-2">
          ...
          <div className="grid grid-cols-1 gap-3 text-xs font-mono">
            ...
            <div className="flex justify-between items-center p-2 rounded-lg bg-background/20">
              ...
              <div className="px-3 py-1 bg-resonance-root/20 border border-resonance-root/30 rounded-full">
            ...
            <div className="flex justify-between items-center p-2 rounded-lg bg-background/20">
              ...
              <div className="px-3 py-1 bg-warning/20 border border-warning/30 rounded-full">
            ...
            <div className="flex justify-between items-center p-2 rounded-lg bg-background/20">
              ...
              <div className="px-3 py-1 bg-tensor-overlay/20 border border-tensor-overlay/30 rounded-full">
            ...
            <div className="flex justify-between items-center p-2 rounded-lg bg-background/20">
              ...
              <div className={`px-3 py-1 rounded-full border ${hardwareData ? 'bg-success/20 border-success/30' : 'bg-muted/20 border-muted/30'}`}>
                <span className={`font-bold ${hardwareData ? 'text-success' : 'text-muted-foreground'}`}>
      ...
      <div className="backdrop-blur-md bg-gradient-to-br from-card/40 to-card/20 border border-success/20 rounded-2xl p-6 shadow-xl relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-3 text-xs font-mono">
            <div className="flex justify-between items-center p-3 rounded-lg bg-background/20 border border-success/10">
            ...
            <div className="flex justify-between items-center p-3 rounded-lg bg-background/20 border border-warning/10">
            ...
            <div className="flex justify-between items-center p-3 rounded-lg bg-background/20 border border-accent/10">
